...
public class Pixelization_Camera_Script : MonoBehaviour {
	...
	void Start () {
		...
		Camera.main.pixelRect = new Rect(0,0,Screen.width/pixelSize,Screen.height/pixelSize);
	...
	void OnPostRender()
	{
		...
		tex = new Texture2D(Mathf.FloorToInt(Camera.main.pixelWidth), Mathf.FloorToInt(Camera.main.pixelHeight));
