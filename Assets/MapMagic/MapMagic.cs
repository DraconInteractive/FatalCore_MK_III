...
namespace MapMagic 
{
	...
	public class MapMagic : MonoBehaviour
	{
		...
		{ 
			...
			{
				Vector3 chunkPos = new Vector3(chunk.coord.x*MapMagic.instance.terrainSize, 0, chunk.coord.z*MapMagic.instance.terrainSize) + transform.position;
		...
		public void OnDrawGizmos ()
		{
			...
			if (previewOutput != null)
				foreach (Chunk tw in terrains.Objects()) tw.Preview();
		}
